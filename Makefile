...
PACKAGE ?= helm-kubeai
XRD_DIR := apis/kubeais
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/kubeais/standard.yaml
...
EXAMPLES := \
    examples/kubeais/minimal.yaml:: \
    examples/kubeais/standard.yaml::
